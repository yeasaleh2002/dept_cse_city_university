...
const Dashboard = () => {
  ...
  const [currentRoutine, setCurrentRoutine] = useState("Math - 9 AM, Physics - 11 AM");
  ...
  return (
    <Box sx={{ flexGrow: 1, padding: "2rem", overflow: "hidden" }}>
      ...
      <Stack direction="row" spacing={2} sx={{ mt: 4 }}>
        <Button variant="contained" color="primary">Upcoming Events</Button>
        <Button variant="outlined" color="secondary">View Admissions</Button>
      </Stack>
    </Box>
  );
};
